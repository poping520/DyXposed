...
public class AnnotationType {
    ...
    public static synchronized AnnotationType getInstance(
        ...
        //@AndroidChanged
        //AnnotationType result = sun.misc.SharedSecrets.getJavaLangAccess().getAnnotationType(annotationClass);
        //if (result == null)
    ...
    private AnnotationType(final Class<? extends Annotation> annotationClass) {
        ...
        //@AndroidChanged
        //sun.misc.SharedSecrets.getJavaLangAccess().setAnnotationType(annotationClass, this);
