...
package com.poping520.dyxposed.libdx.dx.command.dexer;

import com.poping520.dyxposed.libdx.dex.Dex;
import com.poping520.dyxposed.libdx.dex.DexException;
import com.poping520.dyxposed.libdx.dex.DexFormat;
import com.poping520.dyxposed.libdx.dex.util.FileUtils;
import com.poping520.dyxposed.libdx.dx.Version;
import com.poping520.dyxposed.libdx.dx.cf.code.SimException;
import com.poping520.dyxposed.libdx.dx.cf.direct.ClassPathOpener;
import com.poping520.dyxposed.libdx.dx.cf.direct.ClassPathOpener.FileNameFilter;
import com.poping520.dyxposed.libdx.dx.cf.direct.DirectClassFile;
import com.poping520.dyxposed.libdx.dx.cf.direct.StdAttributeFactory;
import com.poping520.dyxposed.libdx.dx.cf.iface.ParseException;
import com.poping520.dyxposed.libdx.dx.command.UsageException;
import com.poping520.dyxposed.libdx.dx.dex.DexOptions;
import com.poping520.dyxposed.libdx.dx.dex.cf.CfOptions;
import com.poping520.dyxposed.libdx.dx.dex.cf.CfTranslator;
import com.poping520.dyxposed.libdx.dx.dex.code.PositionList;
import com.poping520.dyxposed.libdx.dx.dex.file.ClassDefItem;
import com.poping520.dyxposed.libdx.dx.dex.file.DexFile;
import com.poping520.dyxposed.libdx.dx.dex.file.EncodedMethod;
import com.poping520.dyxposed.libdx.dx.merge.CollisionPolicy;
import com.poping520.dyxposed.libdx.dx.merge.DexMerger;
import com.poping520.dyxposed.libdx.dx.rop.annotation.Annotation;
import com.poping520.dyxposed.libdx.dx.rop.annotation.Annotations;
import com.poping520.dyxposed.libdx.dx.rop.annotation.AnnotationsList;
import com.poping520.dyxposed.libdx.dx.rop.code.RegisterSpec;
import com.poping520.dyxposed.libdx.dx.rop.cst.CstNat;
import com.poping520.dyxposed.libdx.dx.rop.cst.CstString;
import com.poping520.dyxposed.libdx.dx.rop.cst.CstType;
import com.poping520.dyxposed.libdx.dx.rop.type.Prototype;
import com.poping520.dyxposed.libdx.dx.rop.type.Type;
...
public class Main {
    ...
    public static class Arguments {
        ...
        public boolean outputIsDirectory = false;
        public boolean outputIsDirectDex = false;
        ...
        private void parseFlags(ArgumentsParser parser) {
            ...
            while (parser.getNext()) {
                if (parser.isArg("--debug")) {
                    ...
                    } else if ("important".equals(pstr)) {
                        positionInfo = PositionList.IMPORTANT;
                    } else if ("lines".equals(pstr)) {
