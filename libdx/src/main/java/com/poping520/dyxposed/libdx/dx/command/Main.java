...
package com.poping520.dyxposed.libdx.dx.command;
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < args.length; i++) {
                ...
                gotCmd = true;
                if (arg.equals("--dex")) {
                    com.poping520.dyxposed.libdx.dx.command.dexer.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--dump")) {
                    com.poping520.dyxposed.libdx.dx.command.dump.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--annotool")) {
                    com.poping520.dyxposed.libdx.dx.command.annotool.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--find-usages")) {
                    com.poping520.dyxposed.libdx.dx.command.findusages.Main.main(without(args, i));
                    break;
